...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('lib_findings_recommendations', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('incident_report_id'); // Foreign key to lib_incident_reports
            $table->text('findings'); // ISD Findings
            $table->text('recommendations'); // Recommendations
            $table->timestamps();
